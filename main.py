...
with tabs[1]:
    ...
    # Motor de Cálculo (Pérdidas simplificadas para este ejemplo)
    perdidas_totales = 0.18 # 18% pérdidas estándar
    engine = SolarEngineeringEngine()
    gen_diaria, pr_sistema = engine.simulacion_energetica(potencia_total_dc, info_ciudad['hsp'], 28, perdidas_totales*100)
